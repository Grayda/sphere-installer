...
DRIVERNAME="sphere-installer" # So I can easily use this script on the next driver! This is also used when copying files, **so make sure your binary filename is the same!**
